...
## 食用方法
[下载语言包.zip文件](https://github.com/aoaoho/DEVONthink-Chinese/releases)，解压后将 `zh_CN.lproj` 目录拷贝或移动到  `/Applications/DEVONthink*.app/Contents/Resources/` （在应用图标上点右键 --> 显示包内容）目录下，重新启动应用即可。

## 更新记录
**2018-05-17**
- 修正因Localizable.strings文件的一处错误而导致的部分翻译未正常显示；
- 一些其他优化。
